...
async def _(event):
    e = await edit_or_reply(event, "HALAH TAI 💕")
    await e.edit("PAKYU")
    await e.edit("TAI!!!")
    await e.edit("BANGSAT!")
    await e.edit("ANJING BAT ANJING")
    await e.edit("KONTOLLLLLLL")
    await e.edit("PUKIMAY")
    await e.edit("ALAH TAI SAYANG SAYANG")
    await e.edit("KONTOL")
    await e.edit("MEMEK")
    await e.edit("BANGSAT")
    await e.edit("BENCI")
    ...
    await e.edit("TAIII")
    await e.edit("LUUUU")
    await e.edit("BANGSATTTTT")
    await e.edit("KONTOOOLLLLL")
    await e.edit("NGENTOD!")
    await e.edit("MY BABY")
    await e.edit("💕💞💘💝")
    await e.edit("💘💕💞💝")
    await e.edit("NGENTOD YUK")
...
async def _(event):
    ...
    sleep(1)
    await typew.edit("`🏃            SINI            🦖`")
    await typew.edit("`🏃           ANJG            🦖`")
    await typew.edit("`🏃         BGST             🦖`")
    await typew.edit("`🏃        KONT             🦖`")
    await typew.edit("`🏃   `AAHHHHHHH`          🦖`")
    await typew.edit("`🏃      KONT             🦖`")
    await typew.edit("`🏃        KUDA          🦖`")
    await typew.edit("`🏃           PUKI      🦖`")
    await typew.edit("`🏃      ANJG          🦖`")
    await typew.edit("`🏃      BGST         🦖`")
    await typew.edit("`🏃      TAII        🦖`")
    await typew.edit("`🏃      KONT       🦖`")
    await typew.edit("`🏃      MMEK      🦖`")
    await typew.edit("`🏃     CROT      🦖`")
    await typew.edit("`🏃MUNCRATT   🦖`")
    await typew.edit("`🏃           🦖`")
    await typew.edit("`🏃            🦖`")
    await typew.edit("`🏃             🦖`")
    await typew.edit("`🏃              🦖`")
...
async def _(event):
    ...
    await e.edit("`SEPEEERTIIIII APAAAA BENTUKKKKKKK CINTA`")
...
async def _(event):
    ...
    if input_str == "cinta":
        ...
        animation_chars = [
            ...
            "`SEKARANG KAMU SUDAH TENANG DI ALAM SANA, SEMOGA TENANG DAN BAHAGIA SELAMANYA`",
        ]
